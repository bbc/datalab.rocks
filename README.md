...
- **data scientist, senior data scientist and lead data scientist with natural language understanding:** you'll be helping the Datalab support the BBC Voice and AI team. This means that you will help us take advantage of new voice interfaces by turning text into audience intent. This intent can then be used to serve audience with the most relevant content given their context and interest. You are experienced in natural language modelling and topic extraction. If you have worked on speech to text that would be a real bonus. Cloud (GCP), containers, CI/CD pipelines and Python are things that excite you.
